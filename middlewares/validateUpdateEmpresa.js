...
const validarActualizarEmpresa = [
  ...
  body("cuit")
    .optional()
    .isInt()
    .withMessage("El CUIT debe ser un número entero.")
    .isNumeric()
    .withMessage("El CUIT  debe contener solo números.")
    .isLength({ min: 1, max: 11 })
    .withMessage("El CUIT debe tener entre 1 y 11 dígitos.")
  ...
  body("telefono")
    .optional()
    .isInt()
    .withMessage("El teléfono debe ser un número entero.")
    .notEmpty()
  ...
  body("email")
    ...
    .custom(async (email, { req }) => {
      ...
      if (empresa && empresa.id !== parseInt(req.params.id)) {
        throw new Error(
          "El correo electrónico ya está en uso por otra empresa."
        );
      }
      return true;
    }),
  ...
  body("localidad_id")
    .optional()
    .isInt()
    .withMessage("La localidad_id debe ser un número entero.")
    .notEmpty()
    .withMessage("La localidad_id es requerida."),
